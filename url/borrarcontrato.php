...
?>
   		...
   		<div class="titulomenu">¿Desea borrar el contrato nº <?php print "$resultado[id_contrato]?"?> </div>
   		...
   		<center><div class="botomborrar">Borrar a <?php print"$resultado[id_contrato]"?></div><br/><?php print"<a href='borradocontrato.php?id=" . $resultado['id_contrato'] . "'><img src='../img/delete.gif' border='0'></img></a>";?></center>
   		<br/>
   		<br/>
