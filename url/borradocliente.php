...
// $img=$_REQUEST['img'];
						...
						$instruccion = "delete from clientes where id_cliente='". $id . "'";
            ...
            //			unlink ($nombreFichero);
   					...
   					?>
   					<div class="titulomenu">Cliente Borrado ></div>
   					<div class="cuerpomenu">
   						El cliente ha sido borrado satisfactoriamente.
   						<?php echo "<META HTTP-EQUIV='refresh' CONTENT='5; URL=clientes.php'>";?>
   					<div class="preguntalogin">Será redireccionado a Playas en 5 segundos.</div>
   					</div>
<?PHP
	include("pie.php");
?>