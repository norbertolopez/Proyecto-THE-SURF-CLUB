...
?>
   		...
   		<div class="titulomenu">¿Desea borrar a <?php print "$resultado[nombre_cliente]?"?> </div>
   		...
   		<center><div class="botomborrar">Borrar a <?php print"$resultado[nombre_cliente]"?></div><br/><?php print"<a href='borradocliente.php?id=" . $resultado['id_cliente'] . "'><img src='../img/delete.gif' border='0'></img></a>";?></center>
   		<br/>
   		<br/>
