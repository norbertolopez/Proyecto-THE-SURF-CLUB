				...
				<div class="menu">
					<div class="menutitulo">
						Acceso General
							...
							<div class="botonmenu"><img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu2"><a href="actividades2.php">Actividades</a></div>
							<div class="botonmenu">&nbsp &nbsp <img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu3"><a href="surfing.php">Surfing</a></div>
							<div class="botonmenu">&nbsp &nbsp <img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu3"><a href="longboard.php">Longboard</a></div>
							<div class="botonmenu">&nbsp &nbsp <img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu3"><a href="surfcompeticion.php">Surf Competicion</a></div>
							<div class="botonmenu">&nbsp &nbsp <img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu3"><a href="bodyboard.php">Bodyboard</a></div>
							<div class="botonmenu">&nbsp &nbsp <img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu3"><a href="entrenamientosp.php">Entrenamientos P.</a></div>
					...
					<div class="menutitulo">
						Acceso Privado
							...
							<div class="botonmenu"><img src="../img/botonmenu.jpg" height="20px" width="20px" border="0"></img></div><div class="listamenu"><a href="playas.php">Pistas</a></div>
