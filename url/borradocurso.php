...
// $img=$_REQUEST['img'];
						...
						$instruccion = "delete from cursos where id_curso='". $id . "'";
            ...
            //			unlink ($nombreFichero);
   					...
   					?>
   					<div class="titulomenu">Curso Borrado ></div>
   					<div class="cuerpomenu">
   						El Monitor ha sido borrado satisfactoriamente.
   						<?php echo "<META HTTP-EQUIV='refresh' CONTENT='5; URL=cursos.php'>";?>
   					<div class="preguntalogin">Será redireccionado a cursos en 5 segundos.</div>
   					</div>
<?PHP
	include("pie.php");
?>